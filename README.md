  ...
  <script>
    async function generateImage() {
      ...
      const response = await fetch("https://api.kie.ai/v1/image", {
        method: "POST",
        headers: {
          "Authorization": "Bearer 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",
